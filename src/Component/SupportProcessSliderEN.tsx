...
export default function SupportProcessSliderEN() {
    ...
    () => [
      {
        ...
        p: "01",
        t: "Reception",
        d: "Entry via email/portal with evidence, criticality, and requester data.",
        image: "/Recepción.jpg",
      },
      {
        id: "proc-2",
        p: "02",
        t: "Categorization",
        d: "Functional/technical classification. Impact and priority are determined.",
      ...
      },
      {
        ...
        p: "03",
        t: "Assignment",
        d: "Referral to N1/N2 and technical escalation if applicable.",
      ...
      },
      {
        ...
        p: "04",
        t: "Follow-up",
        d: "Periodic updates, workaround if applicable, and traceability.",
      ...
      },
      {
        ...
        p: "05",
        t: "Closure",
        d: "Validation with user, documentation, and recording for metrics.",
        image: "/Cierre.jpg",
      },
    ],
    []
  ...
  return (
    <section className="border-t border-neutral-200 bg-neutral-50/60 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Encabezado */}
        <h2 className="text-3xl font-bold tracking-tight">Support Process</h2>
        <p className="mt-2 max-w-2xl leading-relaxed text-neutral-600">
          Standard ticket flow from reception to closure, with control and
          ...
          <div className="mt-6 flex justify-center">
            <div className="w-72 sm:w-96">
              <div
                ...
                aria-label="Slider navigation bar"
              >
