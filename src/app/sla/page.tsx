    ...
    <main className="bg-white text-neutral-900">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        ...
        <p className="mt-3 max-w-3xl text-neutral-600">
          Definimos tiempos objetivos y un proceso de atención simple y
          trazable. Niveles de criticidad, canales, métricas y
          responsabilidades quedan claros desde el día uno, y pueden
          ajustarse por contrato o SOW según la realidad de cada operación.
        </p>
      </section>
...
<section className="border-t border-neutral-200 bg-white py-20">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <p className="mt-2 max-w-3xl text-neutral-600 leading-relaxed">
      ...
      <strong>respuesta</strong> dentro de la ventana hábil. 
      El tiempo de resolución dependerá del diagnóstico, alcance y ventanas de cambio disponibles.
    </p>
      ...
      <table className="w-full min-w-[720px] text-xs sm:text-sm">
        ...
        <tbody className="divide-y divide-neutral-100">
          <tr className="hover:bg-neutral-50/80 transition-colors">
            ...
            <td className="p-4">
              Corte productivo, impacto masivo en la operación, sin workaround disponible.
            </td>
          ...
          <tr className="hover:bg-neutral-50/80 transition-colors">
            ...
            <td className="p-4">
              Impacto alto con workaround parcial disponible. Afecta procesos relevantes.
            </td>
          ...
          <tr className="hover:bg-neutral-50/80 transition-colors">
            ...
            <td className="p-4">
              Funcionalidad afectada para un grupo acotado de usuarios o casos específicos.
            </td>
            <td className="p-4 font-medium">4 horas</td>
    ...
    <p className="mt-4 text-xs text-neutral-500 leading-relaxed">
      Horas consideradas como <strong>hábiles</strong> dentro de la ventana de soporte acordada.{" "}
      Los tiempos pueden ajustarse por contrato/SOW según la criticidad del negocio y la cobertura requerida.
    </p>
  </div>
</section>
